...
export const PlayerList = () => {
  ...
  if (isLoading) return <div className="text-center p-4">Caricamento giocatori...</div>;
  if (isError) return <div className="text-center p-4 text-red-500">Errore nel caricamento.</div>;

  return (
    <div className="w-full max-w-4xl mx-auto mt-8 p-6 bg-white rounded-lg border shadow-sm">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold">Rosa Giocatori ({players?.length})</h2>
