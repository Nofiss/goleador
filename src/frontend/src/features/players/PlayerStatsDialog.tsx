					...
					<div className="space-y-6 py-4">
						...
						<div className="grid grid-cols-3 gap-4 text-center">
							<div className="p-3 bg-green-100 rounded-lg">
								...
								<div className="text-xs text-green-600 font-semibold uppercase">Vittorie</div>
							</div>
							<div className="p-3 bg-gray-100 rounded-lg">
								<div className="text-2xl font-bold text-gray-700">{stats.draws}</div>
								<div className="text-xs text-gray-500 font-semibold uppercase">Pareggi</div>
							</div>
							<div className="p-3 bg-red-100 rounded-lg">
								<div className="text-2xl font-bold text-red-700">{stats.losses}</div>
								<div className="text-xs text-red-600 font-semibold uppercase">Sconfitte</div>
							</div>
						</div>
						...
						<div className="flex justify-between items-center px-4">
							<div className="flex items-center gap-2">
								...
								<div>
									<span className="block text-sm text-gray-500">Goal Fatti</span>
							...
							<div className="flex items-center gap-2">
								...
								<div>
									<span className="block text-sm text-gray-500">Goal Subiti</span>
						...
						<div className="bg-secondary p-4 rounded-lg">
							<div className="flex items-center gap-2 mb-2">
								...
								<span className="text-xs font-semibold uppercase text-gray-500">Forma Recente</span>
							</div>
