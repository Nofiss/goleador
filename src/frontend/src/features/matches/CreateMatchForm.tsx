...
export const CreateMatchForm = () => {
  ...
  return (
    <div className="max-w-xl mx-auto p-6 bg-white border rounded-lg shadow-sm">
      <h2 className="text-2xl font-bold mb-6 text-center">Registra Risultato 1vs1</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div className="space-y-2">
            ...
            <Select 
                onValueChange={(val) => setFormData({...formData, playerHomeId: val})}
          ...
          <div className="space-y-2">
            ...
            <Select 
                onValueChange={(val) => setFormData({...formData, playerAwayId: val})}
        ...
        <div className="flex items-center justify-center gap-4 bg-gray-50 p-4 rounded-lg">
            <div className="text-center">
                <Input 
                    type="number" min="0" className="w-20 text-center text-2xl font-bold"
        ...
        {message && (
          <div className={`p-3 rounded text-center text-sm font-medium ${message.startsWith('✅') ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
            {message}
          </div>
        )}
      </form>
