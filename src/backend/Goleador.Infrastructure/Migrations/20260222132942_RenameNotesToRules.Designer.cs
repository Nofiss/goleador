...
namespace Goleador.Infrastructure.Migrations
{
    ...
    [Migration("20260222132942_RenameNotesToRules")]
    partial class RenameNotesToRules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Goleador.Domain.Entities.MatchCardUsage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Goleador.Domain.Entities.TournamentCardDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TournamentCardDefinitions");
                });
            ...
            modelBuilder.Entity("Goleador.Domain.Entities.MatchCardUsage", b =>
                {
                    b.HasOne("Goleador.Domain.Entities.TournamentCardDefinition", "CardDefinition")
                        .WithMany()
                    ...
                    b.HasOne("Goleador.Domain.Entities.TournamentTeam", "Team")
                        .WithMany()
